...
Additionally, you are solely responsible for testing, security and optimizing all code and assets on this GitHub repo, and all such code and assets should be considered:
